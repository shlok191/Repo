...
80102088:	68 9e 79 10 80       	push   $0x8010799e
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 22 59 10 80 	movl   $0x80105922,0x14(%eax)
  p->context = (struct context*)sp;
...
801041fb:	68 b7 7b 10 80       	push   $0x80107bb7
...
80104c04:	68 94 79 10 80       	push   $0x80107994
...
80104c1c:	68 93 79 10 80       	push   $0x80107993
...
80104c31:	68 87 79 10 80       	push   $0x80107987
...
80104c4f:	68 96 79 10 80       	push   $0x80107996
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 78 79 10 80       	push   $0x80107978
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 94 79 10 80       	push   $0x80107994
...
80105078:	68 93 79 10 80       	push   $0x80107993
...
80105216:	75 f0                	jne    80105208 <custom_strrchr+0x18>
	}
...
80105224:	8b 45 08             	mov    0x8(%ebp),%eax
	while(*str != '\0'){
80105227:	0f b6 08             	movzbl (%eax),%ecx
8010522a:	84 c9                	test   %cl,%cl
8010522c:	74 23                	je     80105251 <extract_filename+0x31>
8010522e:	89 c2                	mov    %eax,%edx
	char* last_occurence = 0;
80105230:	31 db                	xor    %ebx,%ebx
80105232:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if(*str == c)
80105238:	80 f9 2f             	cmp    $0x2f,%cl
8010523b:	0f 44 da             	cmove  %edx,%ebx
	while(*str != '\0'){
8010523e:	0f b6 4a 01          	movzbl 0x1(%edx),%ecx
		str++;
80105242:	83 c2 01             	add    $0x1,%edx
	while(*str != '\0'){
80105245:	84 c9                	test   %cl,%cl
80105247:	75 ef                	jne    80105238 <extract_filename+0x18>
	if(filename == 0){
		filename = path;
	}
		...
		filename++;
80105249:	8d 53 01             	lea    0x1(%ebx),%edx
8010524c:	85 db                	test   %ebx,%ebx
8010524e:	0f 45 c2             	cmovne %edx,%eax
	}
...
80105279:	0f 88 de 00 00 00    	js     8010535d <sys_open+0xfd>
...
80105292:	0f 88 c5 00 00 00    	js     8010535d <sys_open+0xfd>
    return -1;
...
801052a1:	0f 85 c1 00 00 00    	jne    80105368 <sys_open+0x108>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801052aa:	ff 75 e0             	push   -0x20(%ebp)
801052ad:	e8 ee cd ff ff       	call   801020a0 <namei>
801052b2:	83 c4 10             	add    $0x10,%esp
801052b5:	89 c6                	mov    %eax,%esi
801052b7:	85 c0                	test   %eax,%eax
801052b9:	0f 84 ca 00 00 00    	je     80105389 <sys_open+0x129>
      end_op();
      return -1;
    }
    ilock(ip);
...
801052c3:	e8 b8 c4 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801052c8:	83 c4 10             	add    $0x10,%esp
801052cb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801052d0:	0f 84 1a 01 00 00    	je     801053f0 <sys_open+0x190>
      end_op();
      return -1;
    }
  }
...
801052d6:	e8 55 bb ff ff       	call   80100e30 <filealloc>
801052db:	89 c3                	mov    %eax,%ebx
801052dd:	85 c0                	test   %eax,%eax
801052df:	74 2f                	je     80105310 <sys_open+0xb0>
  struct proc *curproc = myproc();
801052e1:	e8 8a e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801052e6:	31 d2                	xor    %edx,%edx
801052e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801052ef:	90                   	nop
    if(curproc->ofile[fd] == 0){
801052f0:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
801052f4:	85 c9                	test   %ecx,%ecx
801052f6:	0f 84 e4 00 00 00    	je     801053e0 <sys_open+0x180>
  for(fd = 0; fd < NOFILE; fd++){
801052fc:	83 c2 01             	add    $0x1,%edx
801052ff:	83 fa 10             	cmp    $0x10,%edx
80105302:	75 ec                	jne    801052f0 <sys_open+0x90>
    if(f)
      fileclose(f);
80105304:	83 ec 0c             	sub    $0xc,%esp
80105307:	53                   	push   %ebx
80105308:	e8 e3 bb ff ff       	call   80100ef0 <fileclose>
8010530d:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80105310:	83 ec 0c             	sub    $0xc,%esp
80105313:	56                   	push   %esi
80105314:	e8 f7 c6 ff ff       	call   80101a10 <iunlockput>
80105319:	83 c4 10             	add    $0x10,%esp
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010531c:	e8 0f bb ff ff       	call   80100e30 <filealloc>
80105321:	89 c7                	mov    %eax,%edi
80105323:	85 c0                	test   %eax,%eax
80105325:	74 25                	je     8010534c <sys_open+0xec>
  struct proc *curproc = myproc();
80105327:	e8 44 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010532c:	31 db                	xor    %ebx,%ebx
8010532e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105330:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105334:	85 d2                	test   %edx,%edx
80105336:	74 60                	je     80105398 <sys_open+0x138>
  for(fd = 0; fd < NOFILE; fd++){
80105338:	83 c3 01             	add    $0x1,%ebx
8010533b:	83 fb 10             	cmp    $0x10,%ebx
8010533e:	75 f0                	jne    80105330 <sys_open+0xd0>
    if(f)
      fileclose(f);
...
80105362:	eb 6d                	jmp    801053d1 <sys_open+0x171>
...
80105383:	0f 85 4d ff ff ff    	jne    801052d6 <sys_open+0x76>
      end_op();
80105389:	e8 42 da ff ff       	call   80102dd0 <end_op>
      return -1;
8010538e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105393:	eb 3c                	jmp    801053d1 <sys_open+0x171>
...
801053df:	90                   	nop
      curproc->ofile[fd] = f;
801053e0:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
801053e4:	e9 33 ff ff ff       	jmp    8010531c <sys_open+0xbc>
801053e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
801053f0:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801053f3:	85 db                	test   %ebx,%ebx
801053f5:	0f 84 db fe ff ff    	je     801052d6 <sys_open+0x76>
801053fb:	e9 4c ff ff ff       	jmp    8010534c <sys_open+0xec>
...
8010542f:	e8 9c f6 ff ff       	call   80104ad0 <create>
...
80105489:	e8 92 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010549e:	e8 7d f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
801054be:	e8 0d f6 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
8010550d:	e8 ce f4 ff ff       	call   801049e0 <argstr>
...
801055b5:	e8 26 f4 ff ff       	call   801049e0 <argstr>
...
801055d1:	e8 4a f3 ff ff       	call   80104920 <argint>
...
801055f0:	e8 6b f0 ff ff       	call   80104660 <memset>
...
8010561a:	e8 71 f2 ff ff       	call   80104890 <fetchint>
...
80105638:	e8 93 f2 ff ff       	call   801048d0 <fetchstr>
...
801056a1:	e8 ca f2 ff ff       	call   80104970 <argptr>
...
{
  return fork();
80105760:	e9 ab e3 ff ff       	jmp    80103b10 <fork>
...
{
  return wait();
80105780:	e9 3b e7 ff ff       	jmp    80103ec0 <wait>
...
8010579c:	e8 7f f1 ff ff       	call   80104920 <argint>
...
801057ae:	e8 ad e9 ff ff       	call   80104160 <kill>
...
801057ed:	e8 2e f1 ff ff       	call   80104920 <argint>
...
80105806:	e8 85 e2 ff ff       	call   80103a90 <growproc>
...
8010583d:	e8 de f0 ff ff       	call   80104920 <argint>
...
8010585a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010585d:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
8010587d:	e8 be e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
...
801058a5:	e8 96 ec ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058c8:	e8 73 ec ff ff       	call   80104540 <release>
  return 0;
...
801058fe:	e8 3d ec ff ff       	call   80104540 <release>
  return xticks;
}
...
8010597e:	00 00 ef 
  initlock(&tickslock, "time");
80105981:	68 d9 79 10 80       	push   $0x801079d9
...
80105a04:	ff 24 85 80 7a 10 80 	jmp    *-0x7fef8580(,%eax,4)
...
80105ae5:	68 3c 7a 10 80       	push   $0x80107a3c
...
80105b37:	68 e4 79 10 80       	push   $0x801079e4
...
80105c53:	68 08 7a 10 80       	push   $0x80107a08
80105c58:	e8 43 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c5d:	83 c4 14             	add    $0x14,%esp
80105c60:	68 de 79 10 80       	push   $0x801079de
...
80105d0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d0f:	bf 00 7b 10 80       	mov    $0x80107b00,%edi
...
801069fd:	68 08 7b 10 80       	push   $0x80107b08
...
80106c2b:	68 4d 7b 10 80       	push   $0x80107b4d
...
80106c90:	68 67 7b 10 80       	push   $0x80107b67
...
80106d18:	68 08 7c 10 80       	push   $0x80107c08
...
80106db9:	68 85 7b 10 80       	push   $0x80107b85
...
80106e1b:	68 9d 7b 10 80       	push   $0x80107b9d
...
80106efc:	68 b9 7b 10 80       	push   $0x80107bb9
...
80106fcc:	68 ca 7b 10 80       	push   $0x80107bca
...
80107042:	68 d4 7b 10 80       	push   $0x80107bd4
...
80107117:	68 ee 7b 10 80       	push   $0x80107bee
