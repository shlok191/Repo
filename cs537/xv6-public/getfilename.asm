...
int main(int argc, char *argv[])
{
  ...
  12:	53                   	push   %ebx
  13:	51                   	push   %ecx
  14:	81 ec 0c 01 00 00    	sub    $0x10c,%esp
  ...
  1a:	83 39 02             	cmpl   $0x2,(%ecx)
{
  1d:	8b 41 04             	mov    0x4(%ecx),%eax
	if (argc != 2)
  20:	74 14                	je     36 <main+0x36>
	{

		printf(2, "Usage: %s <name_of_file>\n", argv[0]);
  22:	51                   	push   %ecx
  23:	ff 30                	pushl  (%eax)
  25:	68 a8 07 00 00       	push   $0x7a8
  2a:	6a 02                	push   $0x2
  2c:	e8 0f 04 00 00       	call   440 <printf>
		exit();
  31:	e8 ad 02 00 00       	call   2e3 <exit>
	}
  ...
  37:	8d b5 e8 fe ff ff    	lea    -0x118(%ebp),%esi
	int fd = open(filename, 0);
  3d:	52                   	push   %edx
  3e:	6a 00                	push   $0x0
  40:	ff 70 04             	pushl  0x4(%eax)
  43:	e8 db 02 00 00       	call   323 <open>
	printf(2, "FD received: %d", fd);
  ...
  62:	56                   	push   %esi
  63:	53                   	push   %ebx
  64:	e8 1a 03 00 00       	call   383 <getfilename>

	printf(2, "XV6_TEST_OUTPUT Open filename: %s\n", buffer);
  69:	83 c4 0c             	add    $0xc,%esp
  6c:	56                   	push   %esi
  6d:	68 d4 07 00 00       	push   $0x7d4
  72:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb f7 07 00 00       	mov    $0x7f7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
