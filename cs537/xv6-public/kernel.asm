...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 0c 0b 11 80 40 	movl   $0x80100640,0x80110b0c
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 08 0b 11 80 90 	movl   $0x80100290,0x80110b08
80100a60:	02 10 80 
  cons.locking = 1;
...
80100e1f:	90                   	nop
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100e20:	83 c3 1c             	add    $0x1c,%ebx
80100e23:	81 fb e4 0a 11 80    	cmp    $0x80110ae4,%ebx
...
80100ef9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  ff = *f;
80100eff:	8b 73 10             	mov    0x10(%ebx),%esi
80100f02:	88 45 e7             	mov    %al,-0x19(%ebp)
80100f05:	8b 43 14             	mov    0x14(%ebx),%eax
  release(&ftable.lock);
...
80100fb6:	ff 73 14             	pushl  0x14(%ebx)
80100fb9:	e8 a2 07 00 00       	call   80101760 <ilock>
    stati(f->ip, st);
80100fbe:	58                   	pop    %eax
80100fbf:	5a                   	pop    %edx
80100fc0:	ff 75 0c             	pushl  0xc(%ebp)
80100fc3:	ff 73 14             	pushl  0x14(%ebx)
80100fc6:	e8 65 0a 00 00       	call   80101a30 <stati>
    iunlock(f->ip);
80100fcb:	59                   	pop    %ecx
80100fcc:	ff 73 14             	pushl  0x14(%ebx)
...
8010101b:	ff 73 14             	pushl  0x14(%ebx)
8010101e:	e8 3d 07 00 00       	call   80101760 <ilock>
    if((r = readi(f->ip, addr, f->off, n)) > 0)
80101023:	57                   	push   %edi
80101024:	ff 73 18             	pushl  0x18(%ebx)
80101027:	56                   	push   %esi
80101028:	ff 73 14             	pushl  0x14(%ebx)
...
80101037:	7e 03                	jle    8010103c <fileread+0x4c>
      f->off += r;
80101039:	01 43 18             	add    %eax,0x18(%ebx)
    iunlock(f->ip);
8010103c:	83 ec 0c             	sub    $0xc,%esp
8010103f:	ff 73 14             	pushl  0x14(%ebx)
...
80101054:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return piperead(f->pipe, addr, n);
80101058:	8b 43 10             	mov    0x10(%ebx),%eax
...
801010df:	90                   	nop
      ...
      if ((r = writei(f->ip, addr + i, f->off, n1)) > 0)
        f->off += r;
801010e0:	01 46 18             	add    %eax,0x18(%esi)
      iunlock(f->ip);
801010e3:	83 ec 0c             	sub    $0xc,%esp
801010e6:	ff 76 14             	pushl  0x14(%esi)
        f->off += r;
...
80101122:	ff 76 14             	pushl  0x14(%esi)
80101125:	e8 36 06 00 00       	call   80101760 <ilock>
      if ((r = writei(f->ip, addr + i, f->off, n1)) > 0)
8010112a:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010112d:	53                   	push   %ebx
8010112e:	ff 76 18             	pushl  0x18(%esi)
80101131:	01 f8                	add    %edi,%eax
80101133:	50                   	push   %eax
80101134:	ff 76 14             	pushl  0x14(%esi)
...
80101183:	c3                   	ret    
    return pipewrite(f->pipe, addr, n);
80101184:	8b 46 10             	mov    0x10(%esi),%eax
...
801011b8:	03 05 78 0b 11 80    	add    0x80110b78,%eax
{
...
80101239:	8b 0d 60 0b 11 80    	mov    0x80110b60,%ecx
{
...
8010125c:	03 05 78 0b 11 80    	add    0x80110b78,%eax
...
80101271:	a1 60 0b 11 80       	mov    0x80110b60,%eax
...
801012c9:	39 05 60 0b 11 80    	cmp    %eax,0x80110b60
...
8010134a:	bb b4 0b 11 80       	mov    $0x80110bb4,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 80 0b 11 80       	push   $0x80110b80
...
80101374:	81 c3 90 00 00 00    	add    $0x90,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb d4 27 11 80    	cmp    $0x801127d4,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb d4 27 11 80    	cmp    $0x801127d4,%ebx
...
801013bb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013c2:	68 80 0b 11 80       	push   $0x80110b80
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 80 0b 11 80       	push   $0x80110b80
      ip->ref++;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb d4 27 11 80    	cmp    $0x801127d4,%ebx
...
80101548:	bb c0 0b 11 80       	mov    $0x80110bc0,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 4b 73 10 80       	push   $0x8010734b
80101555:	68 80 0b 11 80       	push   $0x80110b80
...
8010157f:	81 fb e0 27 11 80    	cmp    $0x801127e0,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 60 0b 11 80       	push   $0x80110b60
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 78 0b 11 80    	pushl  0x80110b78
8010159d:	ff 35 74 0b 11 80    	pushl  0x80110b74
801015a3:	ff 35 70 0b 11 80    	pushl  0x80110b70
801015a9:	ff 35 6c 0b 11 80    	pushl  0x80110b6c
801015af:	ff 35 68 0b 11 80    	pushl  0x80110b68
801015b5:	ff 35 64 0b 11 80    	pushl  0x80110b64
801015bb:	ff 35 60 0b 11 80    	pushl  0x80110b60
...
801015f0:	83 3d 68 0b 11 80 01 	cmpl   $0x1,0x80110b68
{
...
8010161f:	3b 3d 68 0b 11 80    	cmp    0x80110b68,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 74 0b 11 80    	add    0x80110b74,%eax
...
801016b8:	03 05 74 0b 11 80    	add    0x80110b74,%eax
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 80 0b 11 80       	push   $0x80110b80
80101743:	e8 18 2e 00 00       	call   80104560 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 80 0b 11 80 	movl   $0x80110b80,(%esp)
...
801017a9:	03 05 74 0b 11 80    	add    0x80110b74,%eax
...
801018be:	e8 7d 2a 00 00       	call   80104340 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 80 0b 11 80 	movl   $0x80110b80,(%esp)
801018ca:	e8 91 2c 00 00       	call   80104560 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 80 0b 11 80 	movl   $0x80110b80,0x8(%ebp)
}
...
801018f3:	68 80 0b 11 80       	push   $0x80110b80
801018f8:	e8 63 2c 00 00       	call   80104560 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 80 0b 11 80 	movl   $0x80110b80,(%esp)
...
80101b3a:	8b 04 c5 00 0b 11 80 	mov    -0x7feef500(,%eax,8),%eax
...
80101c4a:	8b 04 c5 04 0b 11 80 	mov    -0x7feef4fc(,%eax,8),%eax
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 80 0b 11 80       	push   $0x80110b80
80101d9c:	e8 bf 27 00 00       	call   80104560 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 80 0b 11 80 	movl   $0x80110b80,(%esp)
...
80102020:	68 82 79 10 80       	push   $0x80107982
...
80102385:	c7 05 d4 27 11 80 00 	movl   $0xfec00000,0x801127d4
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 d4 27 11 80    	mov    0x801127d4,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
...
801023d8:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d d4 27 11 80    	mov    0x801127d4,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 d4 27 11 80       	mov    0x801127d4,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb 48 56 11 80    	cmp    $0x80115648,%ebx
...
801024a6:	e8 c5 21 00 00       	call   80104670 <memset>
  ...
  if(kmem.use_lock)
801024ab:	8b 15 14 28 11 80    	mov    0x80112814,%edx
...
801024b8:	a1 18 28 11 80       	mov    0x80112818,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 14 28 11 80       	mov    0x80112814,%eax
  kmem.freelist = r;
801024c4:	89 1d 18 28 11 80    	mov    %ebx,0x80112818
  if(kmem.use_lock)
...
801024db:	68 e0 27 11 80       	push   $0x801127e0
801024e0:	e8 7b 20 00 00       	call   80104560 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 e0 27 11 80 	movl   $0x801127e0,0x8(%ebp)
}
...
80102574:	68 e0 27 11 80       	push   $0x801127e0
...
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 14 28 11 80 00 	movl   $0x0,0x80112814
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 14 28 11 80 01 	movl   $0x1,0x80112814
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 14 28 11 80       	mov    0x80112814,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 18 28 11 80       	mov    0x80112818,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 18 28 11 80    	mov    %edx,0x80112818
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 e0 27 11 80       	push   $0x801127e0
80102663:	e8 f8 1e 00 00       	call   80104560 <acquire>
  r = kmem.freelist;
80102668:	a1 18 28 11 80       	mov    0x80112818,%eax
  if(r)
8010266d:	8b 15 14 28 11 80    	mov    0x80112814,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d 18 28 11 80    	mov    %ecx,0x80112818
  if(kmem.use_lock)
...
8010268c:	68 e0 27 11 80       	push   $0x801127e0
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 1c 28 11 80       	mov    0x8011281c,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 1c 28 11 80       	mov    0x8011281c,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 1c 28 11 80       	mov    0x8011281c,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 1c 28 11 80       	mov    0x8011281c,%eax
...
80102b90:	8b 0d 68 28 11 80    	mov    0x80112868,%ecx
...
80102bb0:	a1 54 28 11 80       	mov    0x80112854,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 64 28 11 80    	pushl  0x80112864
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd 6c 28 11 80 	pushl  -0x7feed794(,%edi,4)
80102bd4:	ff 35 64 28 11 80    	pushl  0x80112864
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c14:	39 3d 68 28 11 80    	cmp    %edi,0x80112868
...
80102c37:	ff 35 54 28 11 80    	pushl  0x80112854
80102c3d:	ff 35 64 28 11 80    	pushl  0x80112864
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 68 28 11 80       	mov    0x80112868,%eax
...
80102c60:	8b 0c 95 6c 28 11 80 	mov    -0x7feed794(,%edx,4),%ecx
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d 64 28 11 80    	mov    %ebx,0x80112864
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 54 28 11 80       	mov    %eax,0x80112854
  log.size = sb.nlog;
80102ccb:	89 15 58 28 11 80    	mov    %edx,0x80112858
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d 68 28 11 80    	mov    %ecx,0x80112868
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 6c 28 11 80 	mov    %ebx,-0x7feed794(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 68 28 11 80 00 	movl   $0x0,0x80112868
80102d17:	00 00 00 
...
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 60 28 11 80       	mov    0x80112860,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 5c 28 11 80       	mov    0x8011285c,%eax
80102d73:	8b 15 68 28 11 80    	mov    0x80112868,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 5c 28 11 80       	mov    %eax,0x8011285c
      release(&log.lock);
...
80102db2:	e8 a9 17 00 00       	call   80104560 <acquire>
  log.outstanding -= 1;
80102db7:	a1 5c 28 11 80       	mov    0x8011285c,%eax
  if(log.committing)
80102dbc:	8b 35 60 28 11 80    	mov    0x80112860,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 5c 28 11 80    	mov    %ebx,0x8011285c
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 60 28 11 80 01 	movl   $0x1,0x80112860
80102de5:	00 00 00 
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d 68 28 11 80    	mov    0x80112868,%ecx
...
80102e0f:	c7 04 24 20 28 11 80 	movl   $0x80112820,(%esp)
    log.committing = 0;
80102e16:	c7 05 60 28 11 80 00 	movl   $0x0,0x80112860
80102e1d:	00 00 00 
    wakeup(&log);
...
80102e40:	a1 54 28 11 80       	mov    0x80112854,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 64 28 11 80    	pushl  0x80112864
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d 6c 28 11 80 	pushl  -0x7feed794(,%ebx,4)
80102e64:	ff 35 64 28 11 80    	pushl  0x80112864
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ea4:	3b 1d 68 28 11 80    	cmp    0x80112868,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 68 28 11 80 00 	movl   $0x0,0x80112868
80102ebd:	00 00 00 
...
80102f1b:	8b 15 68 28 11 80    	mov    0x80112868,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 58 28 11 80       	mov    0x80112858,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 5c 28 11 80       	mov    0x8011285c,%eax
...
80102f52:	e8 09 16 00 00       	call   80104560 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 68 28 11 80    	mov    0x80112868,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 6c 28 11 80 	cmp    %ecx,-0x7feed794(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 6c 28 11 80 	mov    %ecx,-0x7feed794(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 6c 28 11 80 	mov    %ecx,-0x7feed794(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 68 28 11 80    	mov    %edx,0x80112868
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 6c 28 11 80       	mov    %eax,0x8011286c
  if (i == log.lh.n)
...
8010305b:	68 48 56 11 80       	push   $0x80115648
...
801032be:	a3 1c 28 11 80       	mov    %eax,0x8011281c
...
8010348b:	89 78 10             	mov    %edi,0x10(%eax)
  (*f1)->type = FD_PIPE;
...
801034a4:	89 78 10             	mov    %edi,0x10(%eax)
  if(*f0)
    fileclose(*f0);
  if(*f1)
    fileclose(*f1);
...
80103794:	bb f4 2e 11 80       	mov    $0x80112ef4,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 c0 2e 11 80       	push   $0x80112ec0
...
801037b3:	81 fb f4 4d 11 80    	cmp    $0x80114df4,%ebx
...
801037d4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037d7:	68 c0 2e 11 80       	push   $0x80112ec0
  p->pid = nextpid++;
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 e6 59 10 80 	movl   $0x801059e6,0x14(%eax)
  p->context = (struct context*)sp;
...
80103833:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103835:	68 c0 2e 11 80       	push   $0x80112ec0
...
80103867:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010386a:	68 c0 2e 11 80       	push   $0x80112ec0
...
801038bf:	68 c0 2e 11 80       	push   $0x80112ec0
...
8010392d:	68 64 78 10 80       	push   $0x80107864
...
80103a4a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a4d:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
80103a54:	e8 07 0b 00 00       	call   80104560 <acquire>
  p->state = RUNNABLE;
80103a59:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a60:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
...
80103bce:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd1:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
80103bd8:	e8 83 09 00 00       	call   80104560 <acquire>
  np->state = RUNNABLE;
80103bdd:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
...
80103c59:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c5c:	bb f4 2e 11 80       	mov    $0x80112ef4,%ebx
    acquire(&ptable.lock);
80103c61:	68 c0 2e 11 80       	push   $0x80112ec0
...
80103cf1:	68 c0 2e 11 80       	push   $0x80112ec0
...
80103dfc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e03:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
...
80103edb:	68 c0 2e 11 80       	push   $0x80112ec0
...
80103f01:	e8 ca fd ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80103f06:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
...
80103f54:	81 fe c0 2e 11 80    	cmp    $0x80112ec0,%esi
80103f5a:	74 4c                	je     80103fa8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f5c:	83 ec 0c             	sub    $0xc,%esp
80103f5f:	68 c0 2e 11 80       	push   $0x80112ec0
...
80103f80:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f87:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
...
80104023:	81 fb f4 4d 11 80    	cmp    $0x80114df4,%ebx
...
80104039:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403e:	81 fb f4 4d 11 80    	cmp    $0x80114df4,%ebx
...
80104054:	68 c0 2e 11 80       	push   $0x80112ec0
...
80104081:	e8 aa 2e 00 00       	call   80106f30 <freevm>
        release(&ptable.lock);
80104086:	c7 04 24 c0 2e 11 80 	movl   $0x80112ec0,(%esp)
        p->pid = 0;
...
801040c1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c6:	68 c0 2e 11 80       	push   $0x80112ec0
...
80104127:	3d f4 4d 11 80       	cmp    $0x80114df4,%eax
8010412c:	75 e4                	jne    80104112 <wakeup+0x32>
  wakeup1(chan);
  release(&ptable.lock);
8010412e:	c7 45 08 c0 2e 11 80 	movl   $0x80112ec0,0x8(%ebp)
}
...
8010418e:	68 c0 2e 11 80       	push   $0x80112ec0
...
801041ab:	68 c0 2e 11 80       	push   $0x80112ec0
...
801041dd:	bb 60 2f 11 80       	mov    $0x80112f60,%ebx
...
80104220:	8b 14 85 8c 78 10 80 	mov    -0x7fef8774(,%eax,4),%edx
      state = "???";
...
801042ae:	68 a4 78 10 80       	push   $0x801078a4
...
80104607:	68 cd 78 10 80       	push   $0x801078cd
...
80104a60:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
80104a88:	68 dd 78 10 80       	push   $0x801078dd
...
80104be4:	68 78 79 10 80       	push   $0x80107978
...
80104bfc:	68 77 79 10 80       	push   $0x80107977
...
80104c11:	68 6b 79 10 80       	push   $0x8010796b
...
80104c2f:	68 7a 79 10 80       	push   $0x8010797a
80104c34:	e8 57 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c39:	83 ec 0c             	sub    $0xc,%esp
80104c3c:	68 5c 79 10 80       	push   $0x8010795c
...
8010502d:	58                   	pop    %eax
8010502e:	5a                   	pop    %edx
8010502f:	68 78 79 10 80       	push   $0x80107978
...
80105048:	68 77 79 10 80       	push   $0x80107977
...
801051cd:	8b 5d 0c             	mov    0xc(%ebp),%ebx

  while (*str != '\0')
801051d0:	0f be 02             	movsbl (%edx),%eax
801051d3:	84 c0                	test   %al,%al
801051d5:	74 19                	je     801051f0 <custom_strrchr+0x30>
801051d7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801051de:	66 90                	xchg   %ax,%ax
  {
    if (*str == c)
801051e0:	39 d8                	cmp    %ebx,%eax
801051e2:	0f 44 ca             	cmove  %edx,%ecx
  while (*str != '\0')
801051e5:	0f be 42 01          	movsbl 0x1(%edx),%eax
      last_occurence = str;

    str++;
801051e9:	83 c2 01             	add    $0x1,%edx
  while (*str != '\0')
801051ec:	84 c0                	test   %al,%al
801051ee:	75 f0                	jne    801051e0 <custom_strrchr+0x20>
  }
...
80105208:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (*str != '\0')
8010520b:	0f b6 0b             	movzbl (%ebx),%ecx
8010520e:	84 c9                	test   %cl,%cl
80105210:	74 2e                	je     80105240 <extract_filename+0x40>
80105212:	89 da                	mov    %ebx,%edx
  char *last_occurence = 0;
80105214:	31 c0                	xor    %eax,%eax
80105216:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010521d:	8d 76 00             	lea    0x0(%esi),%esi
    if (*str == c)
80105220:	80 f9 2f             	cmp    $0x2f,%cl
80105223:	0f 44 c2             	cmove  %edx,%eax
  while (*str != '\0')
80105226:	0f b6 4a 01          	movzbl 0x1(%edx),%ecx
    str++;
8010522a:	83 c2 01             	add    $0x1,%edx
  while (*str != '\0')
8010522d:	84 c9                	test   %cl,%cl
8010522f:	75 ef                	jne    80105220 <extract_filename+0x20>
    filename = path;
  }
...
80105238:	5b                   	pop    %ebx
    filename++;
80105239:	0f 45 c2             	cmovne %edx,%eax
}
8010523c:	5d                   	pop    %ebp
8010523d:	c3                   	ret    
...
80105263:	e8 98 f7 ff ff       	call   80104a00 <argstr>
80105268:	83 c4 10             	add    $0x10,%esp
8010526b:	85 c0                	test   %eax,%eax
8010526d:	0f 88 9a 00 00 00    	js     8010530d <sys_open+0xbd>
80105273:	83 ec 08             	sub    $0x8,%esp
80105276:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105279:	50                   	push   %eax
8010527a:	6a 01                	push   $0x1
8010527c:	e8 cf f6 ff ff       	call   80104950 <argint>
80105281:	83 c4 10             	add    $0x10,%esp
80105284:	85 c0                	test   %eax,%eax
80105286:	0f 88 81 00 00 00    	js     8010530d <sys_open+0xbd>
    return -1;

  begin_op();
8010528c:	e8 9f da ff ff       	call   80102d30 <begin_op>

  if (omode & O_CREATE)
80105291:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105295:	0f 85 85 00 00 00    	jne    80105320 <sys_open+0xd0>
      return -1;
    }
  }
  else
...
8010529e:	ff 75 e0             	pushl  -0x20(%ebp)
801052a1:	e8 8a cd ff ff       	call   80102030 <namei>
801052a6:	83 c4 10             	add    $0x10,%esp
801052a9:	89 c7                	mov    %eax,%edi
801052ab:	85 c0                	test   %eax,%eax
801052ad:	0f 84 8a 00 00 00    	je     8010533d <sys_open+0xed>
    {
      end_op();
      return -1;
    }
...
801052b7:	e8 a4 c4 ff ff       	call   80101760 <ilock>
    if (ip->type == T_DIR && omode != O_RDONLY)
801052bc:	83 c4 10             	add    $0x10,%esp
801052bf:	66 83 7f 50 01       	cmpw   $0x1,0x50(%edi)
801052c4:	0f 84 06 01 00 00    	je     801053d0 <sys_open+0x180>
      end_op();
      return -1;
    }
  }
...
801052ca:	e8 31 bb ff ff       	call   80100e00 <filealloc>
801052cf:	85 c0                	test   %eax,%eax
801052d1:	89 45 d4             	mov    %eax,-0x2c(%ebp)
801052d4:	74 26                	je     801052fc <sys_open+0xac>
  struct proc *curproc = myproc();
801052d6:	e8 85 e6 ff ff       	call   80103960 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
801052db:	8b 55 d4             	mov    -0x2c(%ebp),%edx
...
80105328:	ba 02 00 00 00       	mov    $0x2,%edx
8010532d:	6a 00                	push   $0x0
8010532f:	e8 7c f7 ff ff       	call   80104ab0 <create>
    if (ip == 0)
...
8010533b:	75 8d                	jne    801052ca <sys_open+0x7a>
      end_op();
8010533d:	e8 5e da ff ff       	call   80102da0 <end_op>
      return -1;
80105342:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105347:	eb 73                	jmp    801053bc <sys_open+0x16c>
80105349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105350:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105353:	89 54 98 28          	mov    %edx,0x28(%eax,%ebx,4)
  iunlock(ip);
80105357:	57                   	push   %edi
      curproc->ofile[fd] = f;
80105358:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  iunlock(ip);
8010535b:	e8 e0 c4 ff ff       	call   80101840 <iunlock>
  end_op();
80105360:	e8 3b da ff ff       	call   80102da0 <end_op>

  f->type = FD_INODE;
80105365:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  f->ip = ip;
  f->off = 0;
...
80105368:	83 c4 10             	add    $0x10,%esp
  f->type = FD_INODE;
8010536b:	c7 02 02 00 00 00    	movl   $0x2,(%edx)
  f->readable = !(omode & O_WRONLY);
80105371:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  f->ip = ip;
80105374:	89 7a 14             	mov    %edi,0x14(%edx)
  f->name = extract_filename(path);
80105377:	8b 7d e0             	mov    -0x20(%ebp),%edi
  f->readable = !(omode & O_WRONLY);
8010537a:	89 c8                	mov    %ecx,%eax
  f->off = 0;
8010537c:	c7 42 18 00 00 00 00 	movl   $0x0,0x18(%edx)
  f->readable = !(omode & O_WRONLY);
80105383:	f7 d0                	not    %eax
80105385:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105388:	83 e1 03             	and    $0x3,%ecx
  f->readable = !(omode & O_WRONLY);
8010538b:	88 42 08             	mov    %al,0x8(%edx)
  while (*str != '\0')
8010538e:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105390:	0f 95 42 09          	setne  0x9(%edx)
  while (*str != '\0')
80105394:	0f b6 0f             	movzbl (%edi),%ecx
80105397:	84 c9                	test   %cl,%cl
80105399:	74 1e                	je     801053b9 <sys_open+0x169>
8010539b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010539f:	90                   	nop
    if (*str == c)
801053a0:	80 f9 2f             	cmp    $0x2f,%cl
801053a3:	0f 44 f0             	cmove  %eax,%esi
  while (*str != '\0')
801053a6:	0f b6 48 01          	movzbl 0x1(%eax),%ecx
    str++;
801053aa:	83 c0 01             	add    $0x1,%eax
  while (*str != '\0')
801053ad:	84 c9                	test   %cl,%cl
801053af:	75 ef                	jne    801053a0 <sys_open+0x150>
    filename++;
801053b1:	8d 46 01             	lea    0x1(%esi),%eax
801053b4:	85 f6                	test   %esi,%esi
801053b6:	0f 45 f8             	cmovne %eax,%edi
  f->name = extract_filename(path);
801053b9:	89 7a 0c             	mov    %edi,0xc(%edx)
...
801053d5:	0f 84 ef fe ff ff    	je     801052ca <sys_open+0x7a>
801053db:	e9 1c ff ff ff       	jmp    801052fc <sys_open+0xac>
...
801053f8:	e8 03 f6 ff ff       	call   80104a00 <argstr>
801053fd:	83 c4 10             	add    $0x10,%esp
80105400:	85 c0                	test   %eax,%eax
80105402:	78 34                	js     80105438 <sys_mkdir+0x58>
80105404:	83 ec 0c             	sub    $0xc,%esp
80105407:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010540a:	31 c9                	xor    %ecx,%ecx
8010540c:	ba 01 00 00 00       	mov    $0x1,%edx
80105411:	6a 00                	push   $0x0
80105413:	e8 98 f6 ff ff       	call   80104ab0 <create>
80105418:	83 c4 10             	add    $0x10,%esp
8010541b:	85 c0                	test   %eax,%eax
8010541d:	74 19                	je     80105438 <sys_mkdir+0x58>
  {
    end_op();
    return -1;
  }
...
80105423:	e8 d8 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801054c2:	e8 39 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
801054c7:	e8 d4 d8 ff ff       	call   80102da0 <end_op>
  return 0;
...
801054f9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054fc:	e8 5f e4 ff ff       	call   80103960 <myproc>
...
80105511:	e8 ea f4 ff ff       	call   80104a00 <argstr>
80105516:	83 c4 10             	add    $0x10,%esp
80105519:	85 c0                	test   %eax,%eax
8010551b:	78 73                	js     80105590 <sys_chdir+0xa0>
8010551d:	83 ec 0c             	sub    $0xc,%esp
80105520:	ff 75 f4             	pushl  -0xc(%ebp)
80105523:	e8 08 cb ff ff       	call   80102030 <namei>
80105528:	83 c4 10             	add    $0x10,%esp
8010552b:	89 c3                	mov    %eax,%ebx
8010552d:	85 c0                	test   %eax,%eax
8010552f:	74 5f                	je     80105590 <sys_chdir+0xa0>
  {
    end_op();
    return -1;
  }
...
80105535:	e8 26 c2 ff ff       	call   80101760 <ilock>
  if (ip->type != T_DIR)
8010553a:	83 c4 10             	add    $0x10,%esp
8010553d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105542:	75 2c                	jne    80105570 <sys_chdir+0x80>
  {
    iunlockput(ip);
    end_op();
    return -1;
...
80105548:	e8 f3 c2 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010554d:	58                   	pop    %eax
8010554e:	ff 76 68             	pushl  0x68(%esi)
80105551:	e8 3a c3 ff ff       	call   80101890 <iput>
  end_op();
80105556:	e8 45 d8 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
8010555b:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80105574:	e8 87 c4 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105579:	e8 22 d8 ff ff       	call   80102da0 <end_op>
    return -1;
8010557e:	83 c4 10             	add    $0x10,%esp
80105581:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105586:	eb db                	jmp    80105563 <sys_chdir+0x73>
80105588:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010558f:	90                   	nop
    end_op();
80105590:	e8 0b d8 ff ff       	call   80102da0 <end_op>
    return -1;
80105595:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010559a:	eb c7                	jmp    80105563 <sys_chdir+0x73>
...
801055a9:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
801055af:	53                   	push   %ebx
801055b0:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if (argstr(0, &path) < 0 || argint(1, (int *)&uargv) < 0)
801055b6:	50                   	push   %eax
801055b7:	6a 00                	push   $0x0
801055b9:	e8 42 f4 ff ff       	call   80104a00 <argstr>
801055be:	83 c4 10             	add    $0x10,%esp
801055c1:	85 c0                	test   %eax,%eax
801055c3:	0f 88 8b 00 00 00    	js     80105654 <sys_exec+0xb4>
801055c9:	83 ec 08             	sub    $0x8,%esp
801055cc:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801055d2:	50                   	push   %eax
801055d3:	6a 01                	push   $0x1
801055d5:	e8 76 f3 ff ff       	call   80104950 <argint>
801055da:	83 c4 10             	add    $0x10,%esp
801055dd:	85 c0                	test   %eax,%eax
801055df:	78 73                	js     80105654 <sys_exec+0xb4>
  {
    return -1;
  }
  memset(argv, 0, sizeof(argv));
801055e1:	83 ec 04             	sub    $0x4,%esp
801055e4:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for (i = 0;; i++)
801055ea:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
801055ec:	68 80 00 00 00       	push   $0x80
801055f1:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801055f7:	6a 00                	push   $0x0
801055f9:	50                   	push   %eax
801055fa:	e8 71 f0 ff ff       	call   80104670 <memset>
...
80105608:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
8010560e:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105615:	83 ec 08             	sub    $0x8,%esp
80105618:	57                   	push   %edi
80105619:	01 f0                	add    %esi,%eax
8010561b:	50                   	push   %eax
8010561c:	e8 8f f2 ff ff       	call   801048b0 <fetchint>
80105621:	83 c4 10             	add    $0x10,%esp
80105624:	85 c0                	test   %eax,%eax
80105626:	78 2c                	js     80105654 <sys_exec+0xb4>
      return -1;
    if (uarg == 0)
80105628:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010562e:	85 c0                	test   %eax,%eax
80105630:	74 36                	je     80105668 <sys_exec+0xc8>
    {
      argv[i] = 0;
      break;
    }
    if (fetchstr(uarg, &argv[i]) < 0)
80105632:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105638:	83 ec 08             	sub    $0x8,%esp
8010563b:	8d 14 31             	lea    (%ecx,%esi,1),%edx
8010563e:	52                   	push   %edx
8010563f:	50                   	push   %eax
80105640:	e8 ab f2 ff ff       	call   801048f0 <fetchstr>
80105645:	83 c4 10             	add    $0x10,%esp
80105648:	85 c0                	test   %eax,%eax
8010564a:	78 08                	js     80105654 <sys_exec+0xb4>
  for (i = 0;; i++)
8010564c:	83 c3 01             	add    $0x1,%ebx
    if (i >= NELEM(argv))
8010564f:	83 fb 20             	cmp    $0x20,%ebx
80105652:	75 b4                	jne    80105608 <sys_exec+0x68>
      return -1;
  }
...
8010566b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
80105671:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105678:	00 00 00 00 
  return exec(path, argv);
8010567c:	50                   	push   %eax
8010567d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80105683:	e8 f8 b3 ff ff       	call   80100a80 <exec>
80105688:	83 c4 10             	add    $0x10,%esp
}
8010568b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010568e:	5b                   	pop    %ebx
8010568f:	5e                   	pop    %esi
80105690:	5f                   	pop    %edi
80105691:	5d                   	pop    %ebp
...
801056a9:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
801056ac:	53                   	push   %ebx
801056ad:	83 ec 20             	sub    $0x20,%esp
  if (argptr(0, (void *)&fd, 2 * sizeof(fd[0])) < 0)
801056b0:	6a 08                	push   $0x8
801056b2:	50                   	push   %eax
801056b3:	6a 00                	push   $0x0
801056b5:	e8 e6 f2 ff ff       	call   801049a0 <argptr>
801056ba:	83 c4 10             	add    $0x10,%esp
801056bd:	85 c0                	test   %eax,%eax
801056bf:	78 4e                	js     8010570f <sys_pipe+0x6f>
    return -1;
...
801056cc:	e8 1f dd ff ff       	call   801033f0 <pipealloc>
801056d1:	83 c4 10             	add    $0x10,%esp
801056d4:	85 c0                	test   %eax,%eax
801056d6:	78 37                	js     8010570f <sys_pipe+0x6f>
    return -1;
  fd0 = -1;
...
801056fe:	e8 bd b7 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
80105703:	58                   	pop    %eax
80105704:	ff 75 e4             	pushl  -0x1c(%ebp)
80105707:	e8 b4 b7 ff ff       	call   80100ec0 <fileclose>
    return -1;
8010570c:	83 c4 10             	add    $0x10,%esp
8010570f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105714:	eb 5b                	jmp    80105771 <sys_pipe+0xd1>
...
80105780:	f3 0f 1e fb          	endbr32 
  return fork();
80105784:	e9 87 e3 ff ff       	jmp    80103b10 <fork>
...
80105797:	83 ec 08             	sub    $0x8,%esp
  exit();
8010579a:	e8 f1 e5 ff ff       	call   80103d90 <exit>
  return 0; // not reached
}
8010579f:	31 c0                	xor    %eax,%eax
801057a1:	c9                   	leave  
801057a2:	c3                   	ret    
801057a3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801057b0:	f3 0f 1e fb          	endbr32 
  return wait();
801057b4:	e9 27 e8 ff ff       	jmp    80103fe0 <wait>
...
801057c7:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
801057d0:	e8 7b f1 ff ff       	call   80104950 <argint>
801057d5:	83 c4 10             	add    $0x10,%esp
801057d8:	85 c0                	test   %eax,%eax
801057da:	78 14                	js     801057f0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801057dc:	83 ec 0c             	sub    $0xc,%esp
801057df:	ff 75 f4             	pushl  -0xc(%ebp)
801057e2:	e8 59 e9 ff ff       	call   80104140 <kill>
...
80105807:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010580a:	e8 51 e1 ff ff       	call   80103960 <myproc>
...
8010583b:	78 23                	js     80105860 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010583d:	e8 1e e1 ff ff       	call   80103960 <myproc>
  if (growproc(n) < 0)
80105842:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105845:	8b 18                	mov    (%eax),%ebx
  if (growproc(n) < 0)
80105847:	ff 75 f4             	pushl  -0xc(%ebp)
8010584a:	e8 41 e2 ff ff       	call   80103a90 <growproc>
8010584f:	83 c4 10             	add    $0x10,%esp
80105852:	85 c0                	test   %eax,%eax
80105854:	78 0a                	js     80105860 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105856:	89 d8                	mov    %ebx,%eax
80105858:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010585b:	c9                   	leave  
8010585c:	c3                   	ret    
8010585d:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
80105860:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105865:	eb ef                	jmp    80105856 <sys_sbrk+0x36>
...
80105880:	e8 cb f0 ff ff       	call   80104950 <argint>
80105885:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105888:	5a                   	pop    %edx
80105889:	59                   	pop    %ecx
8010588a:	50                   	push   %eax
8010588b:	6a 01                	push   $0x1
8010588d:	e8 6e f1 ff ff       	call   80104a00 <argstr>
80105892:	83 c4 10             	add    $0x10,%esp
80105895:	83 f8 ff             	cmp    $0xffffffff,%eax
80105898:	74 46                	je     801058e0 <sys_getfilename+0x70>
8010589a:	83 ec 08             	sub    $0x8,%esp
8010589d:	8d 45 f0             	lea    -0x10(%ebp),%eax
801058a0:	50                   	push   %eax
801058a1:	6a 02                	push   $0x2
801058a3:	e8 a8 f0 ff ff       	call   80104950 <argint>
801058a8:	83 c4 10             	add    $0x10,%esp
801058ab:	83 f8 ff             	cmp    $0xffffffff,%eax
801058ae:	74 30                	je     801058e0 <sys_getfilename+0x70>
  {
    return -1;
  }
...
801058b5:	74 29                	je     801058e0 <sys_getfilename+0x70>
  {
    return -1;
  }
...
801058b7:	e8 a4 e0 ff ff       	call   80103960 <myproc>
801058bc:	8b 55 ec             	mov    -0x14(%ebp),%edx
801058bf:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax

  // Invalid file
  if (f == 0)
801058c3:	85 c0                	test   %eax,%eax
801058c5:	74 19                	je     801058e0 <sys_getfilename+0x70>
  {
    return -1;
  }
...
801058ca:	ff 75 f0             	pushl  -0x10(%ebp)
801058cd:	ff 70 0c             	pushl  0xc(%eax)
801058d0:	ff 75 f4             	pushl  -0xc(%ebp)
801058d3:	e8 58 ef ff ff       	call   80104830 <safestrcpy>
...
80105901:	e8 4a f0 ff ff       	call   80104950 <argint>
...
80105914:	68 00 4e 11 80       	push   $0x80114e00
80105919:	e8 42 ec ff ff       	call   80104560 <acquire>
  ticks0 = ticks;
  while (ticks - ticks0 < n)
8010591e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105921:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  while (ticks - ticks0 < n)
...
80105933:	68 00 4e 11 80       	push   $0x80114e00
80105938:	68 40 56 11 80       	push   $0x80115640
8010593d:	e8 de e5 ff ff       	call   80103f20 <sleep>
  while (ticks - ticks0 < n)
80105942:	a1 40 56 11 80       	mov    0x80115640,%eax
...
80105960:	68 00 4e 11 80       	push   $0x80114e00
80105965:	e8 b6 ec ff ff       	call   80104620 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105983:	68 00 4e 11 80       	push   $0x80114e00
80105988:	e8 93 ec ff ff       	call   80104620 <release>
  return 0;
...
801059a8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059ab:	68 00 4e 11 80       	push   $0x80114e00
801059b0:	e8 ab eb ff ff       	call   80104560 <acquire>
  xticks = ticks;
801059b5:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  release(&tickslock);
801059bb:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
801059c2:	e8 59 ec ff ff       	call   80104620 <release>
  return xticks;
}
...
801059cf:	06                   	push   %es
  pushl %fs
801059d0:	0f a0                	push   %fs
  pushl %gs
801059d2:	0f a8                	push   %gs
  pushal
801059d4:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801059d5:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801059d9:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801059db:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801059dd:	54                   	push   %esp
  call trap
801059de:	e8 cd 00 00 00       	call   80105ab0 <trap>
  addl $4, %esp
801059e3:	83 c4 04             	add    $0x4,%esp
...
801059e6:	61                   	popa   
  popl %gs
801059e7:	0f a9                	pop    %gs
  popl %fs
801059e9:	0f a1                	pop    %fs
  popl %es
801059eb:	07                   	pop    %es
  popl %ds
801059ec:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801059ed:	83 c4 08             	add    $0x8,%esp
  iret
801059f0:	cf                   	iret   
801059f1:	66 90                	xchg   %ax,%ax
...
80105a17:	c7 04 c5 42 4e 11 80 	movl   $0x8e000008,-0x7feeb1be(,%eax,8)
80105a1e:	08 00 00 8e 
80105a22:	66 89 14 c5 40 4e 11 	mov    %dx,-0x7feeb1c0(,%eax,8)
80105a29:	80 
80105a2a:	c1 ea 10             	shr    $0x10,%edx
80105a2d:	66 89 14 c5 46 4e 11 	mov    %dx,-0x7feeb1ba(,%eax,8)
80105a34:	80 
  for(i = 0; i < 256; i++)
...
80105a47:	c7 05 42 50 11 80 08 	movl   $0xef000008,0x80115042
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 bd 79 10 80       	push   $0x801079bd
80105a56:	68 00 4e 11 80       	push   $0x80114e00
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a5b:	66 a3 40 50 11 80    	mov    %ax,0x80115040
80105a61:	c1 e8 10             	shr    $0x10,%eax
80105a64:	66 a3 46 50 11 80    	mov    %ax,0x80115046
  initlock(&tickslock, "time");
80105a6a:	e8 71 e9 ff ff       	call   801043e0 <initlock>
}
...
80105a8f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a93:	b8 40 4e 11 80       	mov    $0x80114e40,%eax
...
80105ad4:	3e ff 24 85 64 7a 10 	notrack jmp *-0x7fef859c(,%eax,4)
80105adb:	80 
    lapiceoi();
    break;
...
80105b31:	68 20 7a 10 80       	push   $0x80107a20
...
80105bd7:	68 00 4e 11 80       	push   $0x80114e00
80105bdc:	e8 7f e9 ff ff       	call   80104560 <acquire>
      wakeup(&ticks);
80105be1:	c7 04 24 40 56 11 80 	movl   $0x80115640,(%esp)
      ticks++;
80105be8:	83 05 40 56 11 80 01 	addl   $0x1,0x80115640
      wakeup(&ticks);
80105bef:	e8 ec e4 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105bf4:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
80105bfb:	e8 20 ea ff ff       	call   80104620 <release>
...
80105c4c:	68 c8 79 10 80       	push   $0x801079c8
...
80105c99:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c9c:	e8 9f ed ff ff       	call   80104a40 <syscall>
    if(myproc()->killed)
...
80105ce8:	68 ec 79 10 80       	push   $0x801079ec
80105ced:	e8 be a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105cf2:	83 c4 14             	add    $0x14,%esp
80105cf5:	68 c2 79 10 80       	push   $0x801079c2
...
80105df3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105df8:	bb e4 7a 10 80       	mov    $0x80107ae4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105e8b:	6a 00                	push   $0x0
  jmp alltraps
80105e8d:	e9 3c fb ff ff       	jmp    801059ce <alltraps>
...
80105e94:	6a 01                	push   $0x1
  jmp alltraps
80105e96:	e9 33 fb ff ff       	jmp    801059ce <alltraps>
...
80105e9d:	6a 02                	push   $0x2
  jmp alltraps
80105e9f:	e9 2a fb ff ff       	jmp    801059ce <alltraps>
...
80105ea6:	6a 03                	push   $0x3
  jmp alltraps
80105ea8:	e9 21 fb ff ff       	jmp    801059ce <alltraps>
...
80105eaf:	6a 04                	push   $0x4
  jmp alltraps
80105eb1:	e9 18 fb ff ff       	jmp    801059ce <alltraps>
...
80105eb8:	6a 05                	push   $0x5
  jmp alltraps
80105eba:	e9 0f fb ff ff       	jmp    801059ce <alltraps>
...
80105ec1:	6a 06                	push   $0x6
  jmp alltraps
80105ec3:	e9 06 fb ff ff       	jmp    801059ce <alltraps>
...
80105eca:	6a 07                	push   $0x7
  jmp alltraps
80105ecc:	e9 fd fa ff ff       	jmp    801059ce <alltraps>
...
80105ed1:	6a 08                	push   $0x8
  jmp alltraps
80105ed3:	e9 f6 fa ff ff       	jmp    801059ce <alltraps>
...
80105eda:	6a 09                	push   $0x9
  jmp alltraps
80105edc:	e9 ed fa ff ff       	jmp    801059ce <alltraps>
...
80105ee1:	6a 0a                	push   $0xa
  jmp alltraps
80105ee3:	e9 e6 fa ff ff       	jmp    801059ce <alltraps>
...
80105ee8:	6a 0b                	push   $0xb
  jmp alltraps
80105eea:	e9 df fa ff ff       	jmp    801059ce <alltraps>
...
80105eef:	6a 0c                	push   $0xc
  jmp alltraps
80105ef1:	e9 d8 fa ff ff       	jmp    801059ce <alltraps>
...
80105ef6:	6a 0d                	push   $0xd
  jmp alltraps
80105ef8:	e9 d1 fa ff ff       	jmp    801059ce <alltraps>
...
80105efd:	6a 0e                	push   $0xe
  jmp alltraps
80105eff:	e9 ca fa ff ff       	jmp    801059ce <alltraps>
...
80105f06:	6a 0f                	push   $0xf
  jmp alltraps
80105f08:	e9 c1 fa ff ff       	jmp    801059ce <alltraps>
...
80105f0f:	6a 10                	push   $0x10
  jmp alltraps
80105f11:	e9 b8 fa ff ff       	jmp    801059ce <alltraps>
...
80105f16:	6a 11                	push   $0x11
  jmp alltraps
80105f18:	e9 b1 fa ff ff       	jmp    801059ce <alltraps>
...
80105f1f:	6a 12                	push   $0x12
  jmp alltraps
80105f21:	e9 a8 fa ff ff       	jmp    801059ce <alltraps>
...
80105f28:	6a 13                	push   $0x13
  jmp alltraps
80105f2a:	e9 9f fa ff ff       	jmp    801059ce <alltraps>
...
80105f31:	6a 14                	push   $0x14
  jmp alltraps
80105f33:	e9 96 fa ff ff       	jmp    801059ce <alltraps>
...
80105f3a:	6a 15                	push   $0x15
  jmp alltraps
80105f3c:	e9 8d fa ff ff       	jmp    801059ce <alltraps>
...
80105f43:	6a 16                	push   $0x16
  jmp alltraps
80105f45:	e9 84 fa ff ff       	jmp    801059ce <alltraps>
...
80105f4c:	6a 17                	push   $0x17
  jmp alltraps
80105f4e:	e9 7b fa ff ff       	jmp    801059ce <alltraps>
...
80105f55:	6a 18                	push   $0x18
  jmp alltraps
80105f57:	e9 72 fa ff ff       	jmp    801059ce <alltraps>
...
80105f5e:	6a 19                	push   $0x19
  jmp alltraps
80105f60:	e9 69 fa ff ff       	jmp    801059ce <alltraps>
...
80105f67:	6a 1a                	push   $0x1a
  jmp alltraps
80105f69:	e9 60 fa ff ff       	jmp    801059ce <alltraps>
...
80105f70:	6a 1b                	push   $0x1b
  jmp alltraps
80105f72:	e9 57 fa ff ff       	jmp    801059ce <alltraps>
...
80105f79:	6a 1c                	push   $0x1c
  jmp alltraps
80105f7b:	e9 4e fa ff ff       	jmp    801059ce <alltraps>
...
80105f82:	6a 1d                	push   $0x1d
  jmp alltraps
80105f84:	e9 45 fa ff ff       	jmp    801059ce <alltraps>
...
80105f8b:	6a 1e                	push   $0x1e
  jmp alltraps
80105f8d:	e9 3c fa ff ff       	jmp    801059ce <alltraps>
...
80105f94:	6a 1f                	push   $0x1f
  jmp alltraps
80105f96:	e9 33 fa ff ff       	jmp    801059ce <alltraps>
...
80105f9d:	6a 20                	push   $0x20
  jmp alltraps
80105f9f:	e9 2a fa ff ff       	jmp    801059ce <alltraps>
...
80105fa6:	6a 21                	push   $0x21
  jmp alltraps
80105fa8:	e9 21 fa ff ff       	jmp    801059ce <alltraps>
...
80105faf:	6a 22                	push   $0x22
  jmp alltraps
80105fb1:	e9 18 fa ff ff       	jmp    801059ce <alltraps>
...
80105fb8:	6a 23                	push   $0x23
  jmp alltraps
80105fba:	e9 0f fa ff ff       	jmp    801059ce <alltraps>
...
80105fc1:	6a 24                	push   $0x24
  jmp alltraps
80105fc3:	e9 06 fa ff ff       	jmp    801059ce <alltraps>
...
80105fca:	6a 25                	push   $0x25
  jmp alltraps
80105fcc:	e9 fd f9 ff ff       	jmp    801059ce <alltraps>
...
80105fd3:	6a 26                	push   $0x26
  jmp alltraps
80105fd5:	e9 f4 f9 ff ff       	jmp    801059ce <alltraps>
...
80105fdc:	6a 27                	push   $0x27
  jmp alltraps
80105fde:	e9 eb f9 ff ff       	jmp    801059ce <alltraps>
...
80105fe5:	6a 28                	push   $0x28
  jmp alltraps
80105fe7:	e9 e2 f9 ff ff       	jmp    801059ce <alltraps>
...
80105fee:	6a 29                	push   $0x29
  jmp alltraps
80105ff0:	e9 d9 f9 ff ff       	jmp    801059ce <alltraps>
...
80105ff7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ff9:	e9 d0 f9 ff ff       	jmp    801059ce <alltraps>
...
80106000:	6a 2b                	push   $0x2b
  jmp alltraps
80106002:	e9 c7 f9 ff ff       	jmp    801059ce <alltraps>
...
80106009:	6a 2c                	push   $0x2c
  jmp alltraps
8010600b:	e9 be f9 ff ff       	jmp    801059ce <alltraps>
...
80106012:	6a 2d                	push   $0x2d
  jmp alltraps
80106014:	e9 b5 f9 ff ff       	jmp    801059ce <alltraps>
...
8010601b:	6a 2e                	push   $0x2e
  jmp alltraps
8010601d:	e9 ac f9 ff ff       	jmp    801059ce <alltraps>
...
80106024:	6a 2f                	push   $0x2f
  jmp alltraps
80106026:	e9 a3 f9 ff ff       	jmp    801059ce <alltraps>
...
8010602d:	6a 30                	push   $0x30
  jmp alltraps
8010602f:	e9 9a f9 ff ff       	jmp    801059ce <alltraps>
...
80106036:	6a 31                	push   $0x31
  jmp alltraps
80106038:	e9 91 f9 ff ff       	jmp    801059ce <alltraps>
...
8010603f:	6a 32                	push   $0x32
  jmp alltraps
80106041:	e9 88 f9 ff ff       	jmp    801059ce <alltraps>
...
80106048:	6a 33                	push   $0x33
  jmp alltraps
8010604a:	e9 7f f9 ff ff       	jmp    801059ce <alltraps>
...
80106051:	6a 34                	push   $0x34
  jmp alltraps
80106053:	e9 76 f9 ff ff       	jmp    801059ce <alltraps>
...
8010605a:	6a 35                	push   $0x35
  jmp alltraps
8010605c:	e9 6d f9 ff ff       	jmp    801059ce <alltraps>
...
80106063:	6a 36                	push   $0x36
  jmp alltraps
80106065:	e9 64 f9 ff ff       	jmp    801059ce <alltraps>
...
8010606c:	6a 37                	push   $0x37
  jmp alltraps
8010606e:	e9 5b f9 ff ff       	jmp    801059ce <alltraps>
...
80106075:	6a 38                	push   $0x38
  jmp alltraps
80106077:	e9 52 f9 ff ff       	jmp    801059ce <alltraps>
...
8010607e:	6a 39                	push   $0x39
  jmp alltraps
80106080:	e9 49 f9 ff ff       	jmp    801059ce <alltraps>
...
80106087:	6a 3a                	push   $0x3a
  jmp alltraps
80106089:	e9 40 f9 ff ff       	jmp    801059ce <alltraps>
...
80106090:	6a 3b                	push   $0x3b
  jmp alltraps
80106092:	e9 37 f9 ff ff       	jmp    801059ce <alltraps>
...
80106099:	6a 3c                	push   $0x3c
  jmp alltraps
8010609b:	e9 2e f9 ff ff       	jmp    801059ce <alltraps>
...
801060a2:	6a 3d                	push   $0x3d
  jmp alltraps
801060a4:	e9 25 f9 ff ff       	jmp    801059ce <alltraps>
...
801060ab:	6a 3e                	push   $0x3e
  jmp alltraps
801060ad:	e9 1c f9 ff ff       	jmp    801059ce <alltraps>
...
801060b4:	6a 3f                	push   $0x3f
  jmp alltraps
801060b6:	e9 13 f9 ff ff       	jmp    801059ce <alltraps>
...
801060bd:	6a 40                	push   $0x40
  jmp alltraps
801060bf:	e9 0a f9 ff ff       	jmp    801059ce <alltraps>
...
801060c6:	6a 41                	push   $0x41
  jmp alltraps
801060c8:	e9 01 f9 ff ff       	jmp    801059ce <alltraps>
...
801060cf:	6a 42                	push   $0x42
  jmp alltraps
801060d1:	e9 f8 f8 ff ff       	jmp    801059ce <alltraps>
...
801060d8:	6a 43                	push   $0x43
  jmp alltraps
801060da:	e9 ef f8 ff ff       	jmp    801059ce <alltraps>
...
801060e1:	6a 44                	push   $0x44
  jmp alltraps
801060e3:	e9 e6 f8 ff ff       	jmp    801059ce <alltraps>
...
801060ea:	6a 45                	push   $0x45
  jmp alltraps
801060ec:	e9 dd f8 ff ff       	jmp    801059ce <alltraps>
...
801060f3:	6a 46                	push   $0x46
  jmp alltraps
801060f5:	e9 d4 f8 ff ff       	jmp    801059ce <alltraps>
...
801060fc:	6a 47                	push   $0x47
  jmp alltraps
801060fe:	e9 cb f8 ff ff       	jmp    801059ce <alltraps>
...
80106105:	6a 48                	push   $0x48
  jmp alltraps
80106107:	e9 c2 f8 ff ff       	jmp    801059ce <alltraps>
...
8010610e:	6a 49                	push   $0x49
  jmp alltraps
80106110:	e9 b9 f8 ff ff       	jmp    801059ce <alltraps>
...
80106117:	6a 4a                	push   $0x4a
  jmp alltraps
80106119:	e9 b0 f8 ff ff       	jmp    801059ce <alltraps>
...
80106120:	6a 4b                	push   $0x4b
  jmp alltraps
80106122:	e9 a7 f8 ff ff       	jmp    801059ce <alltraps>
...
80106129:	6a 4c                	push   $0x4c
  jmp alltraps
8010612b:	e9 9e f8 ff ff       	jmp    801059ce <alltraps>
...
80106132:	6a 4d                	push   $0x4d
  jmp alltraps
80106134:	e9 95 f8 ff ff       	jmp    801059ce <alltraps>
...
8010613b:	6a 4e                	push   $0x4e
  jmp alltraps
8010613d:	e9 8c f8 ff ff       	jmp    801059ce <alltraps>
...
80106144:	6a 4f                	push   $0x4f
  jmp alltraps
80106146:	e9 83 f8 ff ff       	jmp    801059ce <alltraps>
...
8010614d:	6a 50                	push   $0x50
  jmp alltraps
8010614f:	e9 7a f8 ff ff       	jmp    801059ce <alltraps>
...
80106156:	6a 51                	push   $0x51
  jmp alltraps
80106158:	e9 71 f8 ff ff       	jmp    801059ce <alltraps>
...
8010615f:	6a 52                	push   $0x52
  jmp alltraps
80106161:	e9 68 f8 ff ff       	jmp    801059ce <alltraps>
...
80106168:	6a 53                	push   $0x53
  jmp alltraps
8010616a:	e9 5f f8 ff ff       	jmp    801059ce <alltraps>
...
80106171:	6a 54                	push   $0x54
  jmp alltraps
80106173:	e9 56 f8 ff ff       	jmp    801059ce <alltraps>
...
8010617a:	6a 55                	push   $0x55
  jmp alltraps
8010617c:	e9 4d f8 ff ff       	jmp    801059ce <alltraps>
...
80106183:	6a 56                	push   $0x56
  jmp alltraps
80106185:	e9 44 f8 ff ff       	jmp    801059ce <alltraps>
...
8010618c:	6a 57                	push   $0x57
  jmp alltraps
8010618e:	e9 3b f8 ff ff       	jmp    801059ce <alltraps>
...
80106195:	6a 58                	push   $0x58
  jmp alltraps
80106197:	e9 32 f8 ff ff       	jmp    801059ce <alltraps>
...
8010619e:	6a 59                	push   $0x59
  jmp alltraps
801061a0:	e9 29 f8 ff ff       	jmp    801059ce <alltraps>
...
801061a7:	6a 5a                	push   $0x5a
  jmp alltraps
801061a9:	e9 20 f8 ff ff       	jmp    801059ce <alltraps>
...
801061b0:	6a 5b                	push   $0x5b
  jmp alltraps
801061b2:	e9 17 f8 ff ff       	jmp    801059ce <alltraps>
...
801061b9:	6a 5c                	push   $0x5c
  jmp alltraps
801061bb:	e9 0e f8 ff ff       	jmp    801059ce <alltraps>
...
801061c2:	6a 5d                	push   $0x5d
  jmp alltraps
801061c4:	e9 05 f8 ff ff       	jmp    801059ce <alltraps>
...
801061cb:	6a 5e                	push   $0x5e
  jmp alltraps
801061cd:	e9 fc f7 ff ff       	jmp    801059ce <alltraps>
...
801061d4:	6a 5f                	push   $0x5f
  jmp alltraps
801061d6:	e9 f3 f7 ff ff       	jmp    801059ce <alltraps>
...
801061dd:	6a 60                	push   $0x60
  jmp alltraps
801061df:	e9 ea f7 ff ff       	jmp    801059ce <alltraps>
...
801061e6:	6a 61                	push   $0x61
  jmp alltraps
801061e8:	e9 e1 f7 ff ff       	jmp    801059ce <alltraps>
...
801061ef:	6a 62                	push   $0x62
  jmp alltraps
801061f1:	e9 d8 f7 ff ff       	jmp    801059ce <alltraps>
...
801061f8:	6a 63                	push   $0x63
  jmp alltraps
801061fa:	e9 cf f7 ff ff       	jmp    801059ce <alltraps>
...
80106201:	6a 64                	push   $0x64
  jmp alltraps
80106203:	e9 c6 f7 ff ff       	jmp    801059ce <alltraps>
...
8010620a:	6a 65                	push   $0x65
  jmp alltraps
8010620c:	e9 bd f7 ff ff       	jmp    801059ce <alltraps>
...
80106213:	6a 66                	push   $0x66
  jmp alltraps
80106215:	e9 b4 f7 ff ff       	jmp    801059ce <alltraps>
...
8010621c:	6a 67                	push   $0x67
  jmp alltraps
8010621e:	e9 ab f7 ff ff       	jmp    801059ce <alltraps>
...
80106225:	6a 68                	push   $0x68
  jmp alltraps
80106227:	e9 a2 f7 ff ff       	jmp    801059ce <alltraps>
...
8010622e:	6a 69                	push   $0x69
  jmp alltraps
80106230:	e9 99 f7 ff ff       	jmp    801059ce <alltraps>
...
80106237:	6a 6a                	push   $0x6a
  jmp alltraps
80106239:	e9 90 f7 ff ff       	jmp    801059ce <alltraps>
...
80106240:	6a 6b                	push   $0x6b
  jmp alltraps
80106242:	e9 87 f7 ff ff       	jmp    801059ce <alltraps>
...
80106249:	6a 6c                	push   $0x6c
  jmp alltraps
8010624b:	e9 7e f7 ff ff       	jmp    801059ce <alltraps>
...
80106252:	6a 6d                	push   $0x6d
  jmp alltraps
80106254:	e9 75 f7 ff ff       	jmp    801059ce <alltraps>
...
8010625b:	6a 6e                	push   $0x6e
  jmp alltraps
8010625d:	e9 6c f7 ff ff       	jmp    801059ce <alltraps>
...
80106264:	6a 6f                	push   $0x6f
  jmp alltraps
80106266:	e9 63 f7 ff ff       	jmp    801059ce <alltraps>
...
8010626d:	6a 70                	push   $0x70
  jmp alltraps
8010626f:	e9 5a f7 ff ff       	jmp    801059ce <alltraps>
...
80106276:	6a 71                	push   $0x71
  jmp alltraps
80106278:	e9 51 f7 ff ff       	jmp    801059ce <alltraps>
...
8010627f:	6a 72                	push   $0x72
  jmp alltraps
80106281:	e9 48 f7 ff ff       	jmp    801059ce <alltraps>
...
80106288:	6a 73                	push   $0x73
  jmp alltraps
8010628a:	e9 3f f7 ff ff       	jmp    801059ce <alltraps>
...
80106291:	6a 74                	push   $0x74
  jmp alltraps
80106293:	e9 36 f7 ff ff       	jmp    801059ce <alltraps>
...
8010629a:	6a 75                	push   $0x75
  jmp alltraps
8010629c:	e9 2d f7 ff ff       	jmp    801059ce <alltraps>
...
801062a3:	6a 76                	push   $0x76
  jmp alltraps
801062a5:	e9 24 f7 ff ff       	jmp    801059ce <alltraps>
...
801062ac:	6a 77                	push   $0x77
  jmp alltraps
801062ae:	e9 1b f7 ff ff       	jmp    801059ce <alltraps>
...
801062b5:	6a 78                	push   $0x78
  jmp alltraps
801062b7:	e9 12 f7 ff ff       	jmp    801059ce <alltraps>
...
801062be:	6a 79                	push   $0x79
  jmp alltraps
801062c0:	e9 09 f7 ff ff       	jmp    801059ce <alltraps>
...
801062c7:	6a 7a                	push   $0x7a
  jmp alltraps
801062c9:	e9 00 f7 ff ff       	jmp    801059ce <alltraps>
...
801062d0:	6a 7b                	push   $0x7b
  jmp alltraps
801062d2:	e9 f7 f6 ff ff       	jmp    801059ce <alltraps>
...
801062d9:	6a 7c                	push   $0x7c
  jmp alltraps
801062db:	e9 ee f6 ff ff       	jmp    801059ce <alltraps>
...
801062e2:	6a 7d                	push   $0x7d
  jmp alltraps
801062e4:	e9 e5 f6 ff ff       	jmp    801059ce <alltraps>
...
801062eb:	6a 7e                	push   $0x7e
  jmp alltraps
801062ed:	e9 dc f6 ff ff       	jmp    801059ce <alltraps>
...
801062f4:	6a 7f                	push   $0x7f
  jmp alltraps
801062f6:	e9 d3 f6 ff ff       	jmp    801059ce <alltraps>
...
801062fd:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106302:	e9 c7 f6 ff ff       	jmp    801059ce <alltraps>
...
80106309:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010630e:	e9 bb f6 ff ff       	jmp    801059ce <alltraps>
...
80106315:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010631a:	e9 af f6 ff ff       	jmp    801059ce <alltraps>
...
80106321:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106326:	e9 a3 f6 ff ff       	jmp    801059ce <alltraps>
...
8010632d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106332:	e9 97 f6 ff ff       	jmp    801059ce <alltraps>
...
80106339:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010633e:	e9 8b f6 ff ff       	jmp    801059ce <alltraps>
...
80106345:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010634a:	e9 7f f6 ff ff       	jmp    801059ce <alltraps>
...
80106351:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106356:	e9 73 f6 ff ff       	jmp    801059ce <alltraps>
...
8010635d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106362:	e9 67 f6 ff ff       	jmp    801059ce <alltraps>
...
80106369:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010636e:	e9 5b f6 ff ff       	jmp    801059ce <alltraps>
...
80106375:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010637a:	e9 4f f6 ff ff       	jmp    801059ce <alltraps>
...
80106381:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106386:	e9 43 f6 ff ff       	jmp    801059ce <alltraps>
...
8010638d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106392:	e9 37 f6 ff ff       	jmp    801059ce <alltraps>
...
80106399:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010639e:	e9 2b f6 ff ff       	jmp    801059ce <alltraps>
...
801063a5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801063aa:	e9 1f f6 ff ff       	jmp    801059ce <alltraps>
...
801063b1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063b6:	e9 13 f6 ff ff       	jmp    801059ce <alltraps>
...
801063bd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063c2:	e9 07 f6 ff ff       	jmp    801059ce <alltraps>
...
801063c9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063ce:	e9 fb f5 ff ff       	jmp    801059ce <alltraps>
...
801063d5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063da:	e9 ef f5 ff ff       	jmp    801059ce <alltraps>
...
801063e1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063e6:	e9 e3 f5 ff ff       	jmp    801059ce <alltraps>
...
801063ed:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063f2:	e9 d7 f5 ff ff       	jmp    801059ce <alltraps>
...
801063f9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063fe:	e9 cb f5 ff ff       	jmp    801059ce <alltraps>
...
80106405:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010640a:	e9 bf f5 ff ff       	jmp    801059ce <alltraps>
...
80106411:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106416:	e9 b3 f5 ff ff       	jmp    801059ce <alltraps>
...
8010641d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106422:	e9 a7 f5 ff ff       	jmp    801059ce <alltraps>
...
80106429:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010642e:	e9 9b f5 ff ff       	jmp    801059ce <alltraps>
...
80106435:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010643a:	e9 8f f5 ff ff       	jmp    801059ce <alltraps>
...
80106441:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106446:	e9 83 f5 ff ff       	jmp    801059ce <alltraps>
...
8010644d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106452:	e9 77 f5 ff ff       	jmp    801059ce <alltraps>
...
80106459:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010645e:	e9 6b f5 ff ff       	jmp    801059ce <alltraps>
...
80106465:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010646a:	e9 5f f5 ff ff       	jmp    801059ce <alltraps>
...
80106471:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106476:	e9 53 f5 ff ff       	jmp    801059ce <alltraps>
...
8010647d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106482:	e9 47 f5 ff ff       	jmp    801059ce <alltraps>
...
80106489:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010648e:	e9 3b f5 ff ff       	jmp    801059ce <alltraps>
...
80106495:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010649a:	e9 2f f5 ff ff       	jmp    801059ce <alltraps>
...
801064a1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801064a6:	e9 23 f5 ff ff       	jmp    801059ce <alltraps>
...
801064ad:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801064b2:	e9 17 f5 ff ff       	jmp    801059ce <alltraps>
...
801064b9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064be:	e9 0b f5 ff ff       	jmp    801059ce <alltraps>
...
801064c5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064ca:	e9 ff f4 ff ff       	jmp    801059ce <alltraps>
...
801064d1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064d6:	e9 f3 f4 ff ff       	jmp    801059ce <alltraps>
...
801064dd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064e2:	e9 e7 f4 ff ff       	jmp    801059ce <alltraps>
...
801064e9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064ee:	e9 db f4 ff ff       	jmp    801059ce <alltraps>
...
801064f5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064fa:	e9 cf f4 ff ff       	jmp    801059ce <alltraps>
...
80106501:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106506:	e9 c3 f4 ff ff       	jmp    801059ce <alltraps>
...
8010650d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106512:	e9 b7 f4 ff ff       	jmp    801059ce <alltraps>
...
80106519:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010651e:	e9 ab f4 ff ff       	jmp    801059ce <alltraps>
...
80106525:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010652a:	e9 9f f4 ff ff       	jmp    801059ce <alltraps>
...
80106531:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106536:	e9 93 f4 ff ff       	jmp    801059ce <alltraps>
...
8010653d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106542:	e9 87 f4 ff ff       	jmp    801059ce <alltraps>
...
80106549:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010654e:	e9 7b f4 ff ff       	jmp    801059ce <alltraps>
...
80106555:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010655a:	e9 6f f4 ff ff       	jmp    801059ce <alltraps>
...
80106561:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106566:	e9 63 f4 ff ff       	jmp    801059ce <alltraps>
...
8010656d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106572:	e9 57 f4 ff ff       	jmp    801059ce <alltraps>
...
80106579:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010657e:	e9 4b f4 ff ff       	jmp    801059ce <alltraps>
...
80106585:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010658a:	e9 3f f4 ff ff       	jmp    801059ce <alltraps>
...
80106591:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106596:	e9 33 f4 ff ff       	jmp    801059ce <alltraps>
...
8010659d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801065a2:	e9 27 f4 ff ff       	jmp    801059ce <alltraps>
...
801065a9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801065ae:	e9 1b f4 ff ff       	jmp    801059ce <alltraps>
...
801065b5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065ba:	e9 0f f4 ff ff       	jmp    801059ce <alltraps>
...
801065c1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065c6:	e9 03 f4 ff ff       	jmp    801059ce <alltraps>
...
801065cd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065d2:	e9 f7 f3 ff ff       	jmp    801059ce <alltraps>
...
801065d9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065de:	e9 eb f3 ff ff       	jmp    801059ce <alltraps>
...
801065e5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065ea:	e9 df f3 ff ff       	jmp    801059ce <alltraps>
...
801065f1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065f6:	e9 d3 f3 ff ff       	jmp    801059ce <alltraps>
...
801065fd:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106602:	e9 c7 f3 ff ff       	jmp    801059ce <alltraps>
...
80106609:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010660e:	e9 bb f3 ff ff       	jmp    801059ce <alltraps>
...
80106615:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010661a:	e9 af f3 ff ff       	jmp    801059ce <alltraps>
...
80106621:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106626:	e9 a3 f3 ff ff       	jmp    801059ce <alltraps>
...
8010662d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106632:	e9 97 f3 ff ff       	jmp    801059ce <alltraps>
...
80106639:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010663e:	e9 8b f3 ff ff       	jmp    801059ce <alltraps>
...
80106645:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010664a:	e9 7f f3 ff ff       	jmp    801059ce <alltraps>
...
80106651:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106656:	e9 73 f3 ff ff       	jmp    801059ce <alltraps>
...
8010665d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106662:	e9 67 f3 ff ff       	jmp    801059ce <alltraps>
...
80106669:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010666e:	e9 5b f3 ff ff       	jmp    801059ce <alltraps>
...
80106675:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010667a:	e9 4f f3 ff ff       	jmp    801059ce <alltraps>
...
80106681:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106686:	e9 43 f3 ff ff       	jmp    801059ce <alltraps>
...
8010668d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106692:	e9 37 f3 ff ff       	jmp    801059ce <alltraps>
...
80106699:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010669e:	e9 2b f3 ff ff       	jmp    801059ce <alltraps>
...
801066a5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801066aa:	e9 1f f3 ff ff       	jmp    801059ce <alltraps>
...
801066b1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066b6:	e9 13 f3 ff ff       	jmp    801059ce <alltraps>
...
801066bd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066c2:	e9 07 f3 ff ff       	jmp    801059ce <alltraps>
...
801066c9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066ce:	e9 fb f2 ff ff       	jmp    801059ce <alltraps>
...
801066d5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066da:	e9 ef f2 ff ff       	jmp    801059ce <alltraps>
...
801066e1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066e6:	e9 e3 f2 ff ff       	jmp    801059ce <alltraps>
...
801066ed:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066f2:	e9 d7 f2 ff ff       	jmp    801059ce <alltraps>
...
801066f9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066fe:	e9 cb f2 ff ff       	jmp    801059ce <alltraps>
...
80106705:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010670a:	e9 bf f2 ff ff       	jmp    801059ce <alltraps>
...
80106711:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106716:	e9 b3 f2 ff ff       	jmp    801059ce <alltraps>
...
8010671d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106722:	e9 a7 f2 ff ff       	jmp    801059ce <alltraps>
...
80106729:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010672e:	e9 9b f2 ff ff       	jmp    801059ce <alltraps>
...
80106735:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010673a:	e9 8f f2 ff ff       	jmp    801059ce <alltraps>
...
80106741:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106746:	e9 83 f2 ff ff       	jmp    801059ce <alltraps>
...
8010674d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106752:	e9 77 f2 ff ff       	jmp    801059ce <alltraps>
...
80106759:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010675e:	e9 6b f2 ff ff       	jmp    801059ce <alltraps>
...
80106765:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010676a:	e9 5f f2 ff ff       	jmp    801059ce <alltraps>
...
80106771:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106776:	e9 53 f2 ff ff       	jmp    801059ce <alltraps>
...
8010677d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106782:	e9 47 f2 ff ff       	jmp    801059ce <alltraps>
...
80106789:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010678e:	e9 3b f2 ff ff       	jmp    801059ce <alltraps>
...
80106795:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010679a:	e9 2f f2 ff ff       	jmp    801059ce <alltraps>
...
801067a1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801067a6:	e9 23 f2 ff ff       	jmp    801059ce <alltraps>
...
801067ad:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801067b2:	e9 17 f2 ff ff       	jmp    801059ce <alltraps>
...
801067b9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067be:	e9 0b f2 ff ff       	jmp    801059ce <alltraps>
...
801067c5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067ca:	e9 ff f1 ff ff       	jmp    801059ce <alltraps>
...
801067d1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067d6:	e9 f3 f1 ff ff       	jmp    801059ce <alltraps>
...
801067dd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067e2:	e9 e7 f1 ff ff       	jmp    801059ce <alltraps>
...
801067e9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067ee:	e9 db f1 ff ff       	jmp    801059ce <alltraps>
...
801067f5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067fa:	e9 cf f1 ff ff       	jmp    801059ce <alltraps>
...
80106801:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106806:	e9 c3 f1 ff ff       	jmp    801059ce <alltraps>
...
8010680d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106812:	e9 b7 f1 ff ff       	jmp    801059ce <alltraps>
...
80106819:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010681e:	e9 ab f1 ff ff       	jmp    801059ce <alltraps>
...
80106825:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010682a:	e9 9f f1 ff ff       	jmp    801059ce <alltraps>
...
80106831:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106836:	e9 93 f1 ff ff       	jmp    801059ce <alltraps>
...
8010683d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106842:	e9 87 f1 ff ff       	jmp    801059ce <alltraps>
...
80106849:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010684e:	e9 7b f1 ff ff       	jmp    801059ce <alltraps>
...
80106855:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010685a:	e9 6f f1 ff ff       	jmp    801059ce <alltraps>
...
80106861:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106866:	e9 63 f1 ff ff       	jmp    801059ce <alltraps>
...
8010686d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106872:	e9 57 f1 ff ff       	jmp    801059ce <alltraps>
...
80106879:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010687e:	e9 4b f1 ff ff       	jmp    801059ce <alltraps>
...
80106885:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010688a:	e9 3f f1 ff ff       	jmp    801059ce <alltraps>
...
80106891:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106896:	e9 33 f1 ff ff       	jmp    801059ce <alltraps>
...
8010689d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801068a2:	e9 27 f1 ff ff       	jmp    801059ce <alltraps>
...
801068a9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801068ae:	e9 1b f1 ff ff       	jmp    801059ce <alltraps>
...
801068b5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068ba:	e9 0f f1 ff ff       	jmp    801059ce <alltraps>
...
801068c1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068c6:	e9 03 f1 ff ff       	jmp    801059ce <alltraps>
...
801068cd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068d2:	e9 f7 f0 ff ff       	jmp    801059ce <alltraps>
...
801068d9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068de:	e9 eb f0 ff ff       	jmp    801059ce <alltraps>
...
801068e5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068ea:	e9 df f0 ff ff       	jmp    801059ce <alltraps>
...
801068f1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068f6:	e9 d3 f0 ff ff       	jmp    801059ce <alltraps>
...
8010695a:	e8 11 dd ff ff       	call   80104670 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069fd:	68 ec 7a 10 80       	push   $0x80107aec
...
80106ade:	c7 80 98 29 11 80 ff 	movl   $0xffff,-0x7feed668(%eax)
80106ae5:	ff 00 00 
80106ae8:	c7 80 9c 29 11 80 00 	movl   $0xcf9a00,-0x7feed664(%eax)
80106aef:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106af2:	c7 80 a0 29 11 80 ff 	movl   $0xffff,-0x7feed660(%eax)
80106af9:	ff 00 00 
80106afc:	c7 80 a4 29 11 80 00 	movl   $0xcf9200,-0x7feed65c(%eax)
80106b03:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b06:	c7 80 a8 29 11 80 ff 	movl   $0xffff,-0x7feed658(%eax)
80106b0d:	ff 00 00 
80106b10:	c7 80 ac 29 11 80 00 	movl   $0xcffa00,-0x7feed654(%eax)
80106b17:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b1a:	c7 80 b0 29 11 80 ff 	movl   $0xffff,-0x7feed650(%eax)
80106b21:	ff 00 00 
80106b24:	c7 80 b4 29 11 80 00 	movl   $0xcff200,-0x7feed64c(%eax)
80106b2b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b2e:	05 90 29 11 80       	add    $0x80112990,%eax
  pd[1] = (uint)p;
...
80106b54:	a1 44 56 11 80       	mov    0x80115644,%eax
...
80106b98:	0f 84 c2 00 00 00    	je     80106c60 <switchuvm+0xf0>
  pushcli();
80106b9e:	e8 bd d8 ff ff       	call   80104460 <pushcli>
...
80106cb3:	e8 b8 d9 ff ff       	call   80104670 <memset>
...
80106ce6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ce7:	e9 24 da ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106cec:	83 ec 0c             	sub    $0xc,%esp
80106cef:	68 31 7b 10 80       	push   $0x80107b31
...
80106e1b:	e8 50 d8 ff ff       	call   80104670 <memset>
...
80106e59:	68 69 7b 10 80       	push   $0x80107b69
...
80106ebb:	68 81 7b 10 80       	push   $0x80107b81
...
80106f9c:	68 9d 7b 10 80       	push   $0x80107b9d
...
80106fd4:	e8 97 d6 ff ff       	call   80104670 <memset>
...
8010703f:	a3 44 56 11 80       	mov    %eax,0x80115644
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107073:	68 ae 7b 10 80       	push   $0x80107bae
...
801070c0:	e8 4b d6 ff ff       	call   80104710 <memmove>
...
80107159:	68 d2 7b 10 80       	push   $0x80107bd2
8010715e:	e8 2d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107163:	83 ec 0c             	sub    $0xc,%esp
80107166:	68 b8 7b 10 80       	push   $0x80107bb8
...
801071ee:	e8 1d d5 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;
