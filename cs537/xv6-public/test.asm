...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 6f 07 00 00       	mov    $0x76f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c5:	a1 20 0a 00 00       	mov    0xa20,%eax
{
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 20 0a 00 00    	mov    0xa20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 20 0a 00 00       	mov    0xa20,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 20 0a 00 00       	mov    %eax,0xa20
}
